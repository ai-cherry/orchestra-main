#!/bin/bash
# Non-interactive GCP Authentication and Deployment Script
# For user: scoobyjava@cherry-ai.me

set -e  # Exit on any error

echo "Starting automatic deployment to GCP Cloud Run..."
...
# Step 4: Deploy to Cloud Run (automatically selected)
