...
def update_orchestrator_config():
    ...
    config_path = Path("config/orchestrator_config_updated.json")
...
async def test_integrated_workflow():
    ...
    # Create orchestrator with updated coordinator
...
async def main():
    ...
    print("🔄 Updating AI Orchestration System...")
    print("="*60)
    ...
    print("   export CURSOR_API_KEY='your-cursor-key'")
    print("   export ANTHROPIC_API_KEY='your-anthropic-key'")
    print("2. Run the enhanced orchestrator:")
    print("   python ai_components/orchestration/ai_orchestrator_enhanced.py")
    print("3. Use the updated CLI:")
    print("   python ai_components/orchestrator_cli_enhanced.py")
