...
def create_codespace_with_gcp(args):
        ...
        try:
            ...
            result = subprocess.run(
                [
                    ...
                    "--iam-account", args.service_account, "/tmp/sa-key.json"
                ],
    ...
    data = {
        ...
        "environment_variables": [
            ...
            for name, value in gcp_env_vars.items()
        ]
    }
...
def create_gcp_sa_for_github(args):
    ...
    result = subprocess.run(
        [
            ...
            "--description", args.description or f"Service account for GitHub repo {args.github_repo}"
        ],
        check=True, capture_output=True, text=True
    )
