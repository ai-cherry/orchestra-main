...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="AI Orchestra Environment Manager"
    )
    ...
    switch_parser.add_argument('environment', choices=['dev', 'staging', 'prod'],
                              help='Environment to switch to')
    
    # Optimize workspace command
    optimize_parser = subparsers.add_parser('optimize-workspace', 
                                           help='Optimize VS Code workspace settings')
    
    # Repository size command
    repo_size_parser = subparsers.add_parser('repo-size', 
                                           help='Analyze repository size')
    
    # Cleanup command
    cleanup_parser = subparsers.add_parser('cleanup', 
                                          help='Clean up repository to reduce size')
