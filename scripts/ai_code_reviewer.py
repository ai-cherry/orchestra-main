...
class AICodeReviewer:
    ...
    def __init__(self):
        ...
        self.forbidden_imports = [
            "docker", "poetry", "pipenv", "setuptools", "distutils",
            "conda", "virtualenv", "tox", "nox"
        ]
        ...
        try:
            ...
            for feature_pattern in self.python311_features:
                if re.search(feature_pattern, content):
                    results["warnings"].append(f"Python 3.11+ feature detected: {feature_pattern} - We use Python 3.10!")
