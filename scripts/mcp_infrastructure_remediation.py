...
class MCPInfrastructureRemediation:
    ...
    def setup_environment_variables(self):
        ...
        missing_vars = [
            ...
            "LAMBDA_PROJECT_ID", "AIRBYTE_API_URL", "MCP_HOST", "SLACK_WEBHOOK_URL",
            "POSTGRES_PORT", "PROMETHEUS_PORT", "POSTGRES_DB", "GEMINI_API_KEY",
            "MCP_STORAGE_TYPE", "LAMBDA_API_KEY", "CIRCUIT_BREAKER_MAX_RETRY_TIMEOUT",
        ...
        with open(self.env_example_file, 'w') as f:
            ...
            categories = {
                ...
                "MCP": ["MCP_"],
                "Weaviate": ["WEAVIATE_"],
                "External Services": ["OPENROUTER_", "GEMINI_", "GITHUB_", "Lambda_", "AIRBYTE_"],
