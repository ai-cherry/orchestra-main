...
"""
    ...
    def run(self):
        ...
        print("🎼 Cherry AI - Complete Setup & Cleanup")
        print("=" * 60)
    ...
    def save_config(self):
        ...
        with open(self.env_file, "w") as f:
            f.write("# Cherry AI Configuration\n")
    ...
    def setup_mcp(self):
        ...
        mcp_config = {
            "name": "Cherry AI MCP",
            "version": "4.0.0",
            "description": "Automated MCP setup for Cherry AI - GCP-free edition",
            "servers": {
                "conductor": {
                    "command": "python",
...
# Check environment
if [ ! -f .env ]; then
    echo "❌ No .env file found. Run: python scripts/cherry_ai_complete_setup.py"
    exit 1
fi
...
echo "Starting cherry_ai API..."
cd core/conductor && uvicorn src.api.main:app --reload --host 0.0.0.0 --port 8000 &
...
"""
        stop_script = """
echo "🛑 Stopping Cherry AI..."

# Stop Python processes
pkill -f "conductor_server.py"
