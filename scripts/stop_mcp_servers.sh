...
echo "🛑 Stopping Orchestra MCP Servers..."
...
# Stop all servers
stop_server "Orchestrator Server" "/tmp/mcp_orchestrator.pid"
...
pkill -f "mcp_server/servers/orchestrator_server.py" 2>/dev/null && echo -e "${GREEN}✅ Killed remaining orchestrator processes${NC}"
