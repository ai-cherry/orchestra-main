...
class UnifiedPostgreSQLMigration:
    ...
    async def migrate_cache(self):
        ...
        try:
            ...
            for table in cache_tables:
                ...
                try:
                    rows = await self.manager.fetch(f"""
    ...
    async def update_code_references(self):
        ...
        for py_file in python_files:
            ...
            if 'venv' in str(py_file) or '__pycache__' in str(py_file) or py_file.name == 'migrate_to_unified_postgresql.py':
                continue
    ...
    async def validate_migration(self):
        ...
        for table, description in required_tables:
            exists = await self.manager.fetchval(f"""
                SELECT EXISTS (
