...
async def demo_agent_coordination():
    ...
    tasks = [
        TaskDefinition(
            ...
            inputs={"code_path": "/root/orchestra-main", "focus": "performance"},
            priority=1
        ),
        TaskDefinition(
            ...
            inputs={"code_path": "/root/orchestra-main", "scan_type": "vulnerabilities"},
            priority=1
        ),
        TaskDefinition(
...
async def main():
    ...
    print("🎼 AI ORCHESTRATOR DEMONSTRATION")
    print("="*60)
    print("Showcasing Roo Coder integration with AI Orchestrator")
    ...
    print("\n🚀 The AI Orchestrator is fully operational!")
