...
def check_vscode_extensions():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            cloud_exts = [
                ext for ext in extensions if "google.cloud-code" in ext.lower()
            ]
            ...
            return (
                bool(all_relevant),
                f"Found Google Cloud/Gemini extensions: {all_relevant}",
            )
        else:
...
def check_cloudbuild_gemini_integration():
    ...
    try:
        ...
        if has_gemini and has_vertex:
            return (
                True,
                "Cloud Build configuration includes Gemini and Vertex AI integration",
            )
        elif has_gemini:
