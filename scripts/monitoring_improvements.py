...
class MonitoringEnhancer:
    ...
    def create_grafana_dashboards(self) -> List[Dict]:
                ...
                "panels": [
                    {
                        ...
                        "targets": [{
                            "expr": "rate(orchestrator_workflows_total[5m])",
                    ...
                    },
                    {
                        ...
                        "targets": [{
                            "expr": "rate(orchestrator_workflows_completed_total[5m]) / rate(orchestrator_workflows_total[5m]) * 100",
                    ...
                    },
                    {
                        ...
                        "targets": [{
                            "expr": "orchestrator_task_duration_seconds_bucket",
                            "format": "heatmap"
                        }]
                    },
                    {
                        ...
                        "targets": [
                            {
                                "expr": "rate(orchestrator_agent_tasks_total{agent='analyzer'}[5m])",
                                "legendFormat": "EigenCode"
                            },
                            {
                                "expr": "rate(orchestrator_agent_tasks_total{agent='implementer'}[5m])",
                                "legendFormat": "Cursor AI"
                            },
                            {
                                "expr": "rate(orchestrator_agent_tasks_total{agent='refiner'}[5m])",
        ...
        dashboards.append(orchestrator_dashboard)
    ...
    def deploy_monitoring_stack(self) -> Dict:
        ...
        alerts_path = Path("/etc/prometheus/alerts/orchestrator.yml")
