...
agent_artifact_repo = gcp.artifactregistry.Repository("agentDockerRepo",
...
dashboard_artifact_repo = gcp.artifactregistry.Repository("dashboardDockerRepo",
...
openai_api_key_secret = gcp.secretmanager.Secret("openaiApiKeySecret",
...
portkey_api_key_secret = gcp.secretmanager.Secret("portkeyApiKeySecret",
...
ai_agent_service = gcp.cloudrunv2.Service("aiAgentService",
...
ai_dashboard_service = gcp.cloudrunv2.Service("aiDashboardService",
...
cloud_run_invoker_binding = gcp.cloudrunv2.ServiceIamPolicy("aiAgentPublicAccess",
...
dashboard_public_access = gcp.cloudrunv2.ServiceIamPolicy("aiDashboardPublicAccess",
                                                          project=project_id,
                                                          location=region,
...
pulumi.export("artifact_registry_repository_url", pulumi.Output.concat(
...
pulumi.export("dashboard_artifact_registry_repository_url", pulumi.Output.concat(
