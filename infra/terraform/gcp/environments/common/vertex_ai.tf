...
resource "google_vertex_ai_index" "orchestra_memory_index" {
  ...
  # Note: dedicated_resources block not supported in current provider version
  # Resource allocation will need to be configured through the GCP console or API
}
...
# Note: google_vertex_ai_index_endpoint_deployment resource not supported in current provider version
# Index deployment will need to be done through the GCP console or API
