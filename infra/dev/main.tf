/**
 * Orchestra Infrastructure Configuration - Development Environment
 *
 * This configuration creates the development environment for the Orchestra platform,
