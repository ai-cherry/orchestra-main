...
echo -e "${BLUE}${BOLD}========================================================================${NC}"
echo -e "${BLUE}${BOLD}   MAKING BADASS GCP-GITHUB TOOLKIT SCRIPTS EXECUTABLE   ${NC}"
echo -e "${BLUE}${BOLD}========================================================================${NC}"
...
echo -e "${YELLOW}For a list of available tools and documentation, see: ${BOLD}BADASS_GCP_GITHUB_TOOLKIT.md${NC}"
