...
try:
    ...
    logging.warning("Google Cloud libraries not found. Install with: pip install google-cloud-aiplatform google-cloud-pubsub google-cloud-run")
...
class VertexAgentManager:
    ...
    def get_or_create_agent(self, display_name: str = "DevOps Bot", description: str = "Orchestra DevOps Agent") -> agent_builder.Agent:
        """
    ...
    def apply_terraform(self, workspace: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if apply_result == 0:
                ...
                return {"status": "failed", "workspace": workspace, "error_code": apply_result}
        except Exception as e:
    ...
    def manage_embeddings(self, data: str, index_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                return {"status": "failed", "error": f"Index endpoint not found: {str(e)}"}
            ...
            try:
                ...
                return {"status": "failed", "error": f"Failed to upsert embedding: {str(e)}"}
