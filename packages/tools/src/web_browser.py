...
class WebBrowserTool(OrchestraTool):
    ...
    description: str = "Browse the web, search for information, and extract content from web pages."
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": f"Error executing web browser action: {str(e)}"
            }
    ...
    def _navigate(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"Request to {url} timed out after {self.timeout} seconds."}
        except requests.exceptions.RequestException as e:
            return {"error": f"Error navigating to {url}: {str(e)}"}
    
    def _extract(self, selectors: Optional[List[str]] = None, extract_links: bool = True) -> Dict[str, Any]:
        """
    ...
    def _back(self) -> Dict[str, Any]:
        ...
        return {
            "error": "Browser history not maintained in this tool."
        }
