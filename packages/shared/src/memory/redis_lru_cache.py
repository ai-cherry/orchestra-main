...
class RedisLRUCache:
    ...
    async def set(self, key: str, value: Any, ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            # Set with expiration
            result = self._redis.setex(name=redis_key, time=ttl, value=serialized)
    ...
    async def get_memory_usage(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "memory_usage_pct": int(info.get("used_memory", 0))
                / (self._max_memory_mb * 1024 * 1024)
                if self._max_memory_mb > 0
                else 0,
    ...
    async def get_user_items(self, user_id: str, limit: int = 50) -> List[MemoryItem]:
        """
