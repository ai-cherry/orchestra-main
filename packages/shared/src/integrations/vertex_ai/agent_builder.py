...
class VertexAIAgentBuilder:
        ...
        try:
            ...
            try:
                ...
                from google.cloud.aiplatform.preview.language_models import (
                    ChatModel, TextGenerationModel, GroundingSource, CodeChatModel
                )
                from vertexai.preview.generative_models import (
                    GenerativeModel, Content, Part, GenerationConfig
                )
            ...
            try:
                from vertexai.agents import Agent, Tool, FunctionDeclaration, Parameter, ExecutionConfig
                ...
                logger.warning("Vertex AI Agent Builder libraries not available. Make sure to use the latest version of the SDK.")
    ...
    async def deploy_agent(self, agent_id: str, deployment_name: str = "production") -> bool:
        ...
        try:
            ...
            # Deploy the agent
            deployment = vertex_agent.deploy(
