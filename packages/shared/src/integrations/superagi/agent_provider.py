...
class SuperAGIAgentProvider:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.warning("SuperAGI client library not available. Install with: pip install superagi-client")
                return False
    ...
    async def _wait_for_agent_completion(self, agent_id: str, run_id: str, 
                                       timeout: int = 600,
    ...
    def _map_to_superagi_config(self, agent_config: Dict[str, Any]) -> Any:
        ...
        goal = agent_config.get("goal", agent_config.get("instructions", ["Assist the user"]))
