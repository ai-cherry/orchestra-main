...
from packages.shared.src.storage.vector.in_memory_vector_search import (
...
def _import_vertex_vector_search():
    from packages.shared.src.storage.vector.vertex_vector_search import (
...
class VectorSearchFactory:
    ...
    def create_vector_search(
        ...
        if provider == "in_memory":
            ...
            return InMemoryVectorSearch(dimensions=dimensions, log_level=log_level)
        elif provider == "vertex":
            # Import here to avoid circular dependencies
            VertexVectorSearchAdapter = _import_vertex_vector_search()

            project_id = config.get("project_id") or os.environ.get(
    ...
    def get_available_providers() -> Dict[str, Type[AbstractVectorSearch]]:
        ...
        """
        providers = {"in_memory": InMemoryVectorSearch}
