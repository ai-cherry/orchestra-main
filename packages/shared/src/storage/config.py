...
def get_collection_name(base_name: str, namespace: Optional[str] = None, 
...
class StorageConfig:
    ...
    def get_collection_name(self, base_name: str, 
                           privacy_level: Optional[PrivacyLevel] = None) -> str:
        """
        ...
        final_privacy_level = privacy_level if privacy_level else self.default_privacy_level
