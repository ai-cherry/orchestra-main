...
class IngestionWorker:
    ...
    async def process_task(self, task: IngestionTask) -> bool:
        ...
        try:
            ...
            await self.firestore.update_task_status(task.id, IngestionStatus.DOWNLOADING)
            ...
            try:
                gcs_raw_path = await self.gcs.upload_raw_file(local_path, task.id, filename)
            except Exception as e:
