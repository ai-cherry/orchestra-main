    ...
    **kwargs
    ...
    try:
        ...
        if not effective_model:
            effective_model = settings.DEFAULT_LLM_MODEL_FALLBACK_ANTHROPIC or "claude-3-5-sonnet-20240620"
        ...
        logger.info(f"Successfully configured Anthropic model: {formatted_model} with Portkey integration")
        return model
