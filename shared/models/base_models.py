...
class PersonaConfig(BaseModel):
    ...
    description: str = Field(description="Description of the persona's personality and behavior")
    traits: Dict[str, Any] = Field(default_factory=dict, description="Personality traits")
    system_prompt: Optional[str] = Field(None, description="System prompt to define the persona")
    knowledge_base: Optional[str] = Field(None, description="Optional reference to a knowledge base")