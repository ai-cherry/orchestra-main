        ...
        try:
            ...
            return {
                ...
                'derived_metrics': {
                    ...
                    'pool_utilization': float(basic_stats['used_connections']) / float(basic_stats['max_size'])
                        if basic_stats['max_size'] > 0 else 0,
                    'connection_efficiency': float(basic_stats['used_connections']) / float(db_stats['total_connections'])
                        if db_stats and db_stats['total_connections'] > 0 else 0
                },
                'health_indicators': {
                    ...
                    'long_running_queries': db_stats and db_stats['longest_query_seconds'] and 
                                          db_stats['longest_query_seconds'] > 60
                }
            }
        ...
        try:
            ...
            return {
                ...
                'diagnostics': {
                    ...
                    'pool_health': 'healthy' if pool_stats['used_connections'] < pool_stats['max_size'] * 0.8 else 'stressed'
                }
            }
