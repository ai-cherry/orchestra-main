...
class SessionExtensionsMixin:
    ...
    async def session_list(self, user_id: Optional[str] = None, agent_id: Optional[str] = None, 
    ...
    async def session_get_active_count(self, user_id: Optional[str] = None, 
                                      agent_id: Optional[str] = None) -> Dict[str, int]:
        """
        ...
        try:
            ...
            result = await self._manager.fetchrow(f"""
                SELECT 
