...
class TestHealthMonitor:
    ...
    async def test_health_status_aggregation(self):
        ...
        try:
            ...
            with patch('core.health_monitor.get_connection_manager') as mock_cm, \
                 patch('core.health_monitor.get_cache_manager') as mock_cache:
                
                mock_cm.return_value.get_metrics.return_value = {
                    "requests": 100,
                    "successes": 95,
                    "success_rate": 0.95
                }
                
                mock_cache.return_value.get_metrics.return_value = {
                    "hit_rate": 0.8
                }
...
class TestUnifiedLLMRouter:
    ...
    async def test_complete_with_mocks(self):
        ...
        with patch('core.llm_router_base.get_cache_manager') as mock_cache_mgr, \
