...
from shared.database.unified_postgresql_enhanced import get_unified_postgresql_enhanced as get_unified_postgresql, close_unified_postgresql
...
class TestUnifiedPostgreSQL:
    ...
    async def test_memory_snapshot(self):
        ...
        # List snapshots
        snapshots = await client.memory_snapshot_list(
            agent_id="test_agent",
            user_id="test_user"
        )
...
class TestBackgroundTasks:
    ...
    async def test_session_cleanup(self):
        ...
        valid_id = await client.session_create(
            user_id="test_user",
            agent_id="test_agent",
            data={},
            ttl=3600
