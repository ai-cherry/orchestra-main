...
def mock_memory_manager():
    ...
    memory_manager.add_raw_agent_data = AsyncMock(
        return_value="mock-agent-data-id-12345"
    )
...
mock_memory_manager_instance.add_memory_item = AsyncMock(
    return_value="mock-memory-item-id-67890"
)
...
mock_memory_manager_instance.add_raw_agent_data = AsyncMock(
    return_value="mock-agent-data-id-67890"
)
...
mock_memory_manager_instance.health_check = AsyncMock(
