...
class BaseGCPService:
    ...
    async def initialize(self) -> None:
        ...
        logger.info(
            f"Initialized {self.service_name} client for project {self.project_id}"
        )
        ...
        try:
            if self.credentials_path and os.path.exists(self.credentials_path):
                ...
                return await loop.run_in_executor(
                    self._executor, service_account.Credentials.get_application_default
                )
            else:
            ...
            raise AuthenticationError(f"Failed to obtain GCP credentials: {e}", cause=e)
...
class SecretManagerService(BaseGCPService):
    ...
    async def _create_client(self) -> SecretManagerServiceClient:
        ...
        loop = asyncio.get_event_loop()
        return await loop.run_in_executor(
            self._executor, partial(SecretManagerServiceClient, credentials=credentials)
        )
    ...
    async def get_secret(self, secret_id: str, version: str = "latest") -> Secret:
        ...
        with ErrorContext(
            ...
            async def get_secret_version(client):
                ...
                loop = asyncio.get_event_loop()
                return await loop.run_in_executor(
                    self._executor, client.access_secret_version, version_name
                )
    ...
    async def list_secrets(self) -> List[Secret]:
        ...
        with ErrorContext(
            ...
            async def list_project_secrets(client):
                ...
                loop = asyncio.get_event_loop()
                return await loop.run_in_executor(
                    self._executor, client.list_secrets, parent
                )
    ...
    async def list_buckets(self) -> List[Bucket]:
        ...
        with ErrorContext(
            ...
            async def list_project_buckets(client):
                loop = asyncio.get_event_loop()
                return await loop.run_in_executor(self._executor, client.list_buckets)
        ...
        with ErrorContext(
            ...
            async def list_bucket_blobs(client):
                ...
                blobs = await loop.run_in_executor(
                    self._executor, partial(bucket.list_blobs, prefix=prefix)
                )
                return list(blobs)
    ...
    async def upload_blob(
        ...
        with ErrorContext(
            ...
            async def upload_file(client):
                ...
                await loop.run_in_executor(self._executor, blob.reload)
    ...
    async def download_blob(
        ...
        with ErrorContext(
            ...
            async def download_file(client):
                ...
                await loop.run_in_executor(
                    self._executor,
                    partial(blob.download_to_filename, destination_file_path),
                )
    ...
    async def delete_blob(self, bucket_name: str, blob_name: str) -> None:
        ...
        with ErrorContext(
            ...
            async def delete_file(client):
                ...
                # Delete the blob
                await loop.run_in_executor(self._executor, blob.delete)
    ...
    async def get_document(
        ...
        with ErrorContext(
            ...
            async def get_doc(client):
                ...
                doc = await loop.run_in_executor(self._executor, doc_ref.get)
    ...
    async def set_document(
        ...
        with ErrorContext(
            ...
            async def set_doc(client):
                ...
                doc_ref = client.collection(collection).document(document_id)
                await loop.run_in_executor(
                    self._executor, partial(doc_ref.set, data, merge=merge)
                )
    ...
    async def query_documents(
        ...
        with ErrorContext(
            ...
            async def query_docs(client):
                ...
                # Execute the query
                docs = await loop.run_in_executor(self._executor, query.stream)
    ...
    async def delete_document(self, collection: str, document_id: str) -> None:
        ...
        with ErrorContext(
            ...
            async def delete_doc(client):
                loop = asyncio.get_event_loop()
                doc_ref = client.collection(collection).document(document_id)
                await loop.run_in_executor(self._executor, doc_ref.delete)
