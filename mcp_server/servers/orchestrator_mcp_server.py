...
MODE_DEFINITIONS_PATH = os.getenv("MODE_DEFINITIONS_PATH", "/home/paperspace/orchestra-main/config/mode_definitions.yaml")
        ...
        MCPToolDefinition(
            ...
            parameters={
                ...
                "properties": {
                    "mode": {
                        "type": "string",
                        "enum": ["standard", "code", "debug", "architect", "strategy", "ask", "creative", "performance"],
