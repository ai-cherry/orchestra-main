...
class MemoryError(MCPError):
    ...
    def __init__(self, message: str, code: str = "MEMORY_ERROR", details: Optional[Dict[str, Any]] = None):
...
class MemoryWriteError(MemoryError):
    ...
    def __init__(self, key: str, scope: str = "session", tool: Optional[str] = None, reason: Optional[str] = None):
        details = {
            "key": key,
            "scope": scope,
            "tool": tool,
...
class MemorySyncError(MemoryError):
    ...
    def __init__(self, key: str, source_tool: str, target_tool: str, scope: str = "session", reason: Optional[str] = None):
        details = {
            "key": key,
            "scope": scope,
