...
class VulnerabilityModel(BaseModel):
    ...
    is_direct: bool = Field(
        True, description="Whether the package is a direct dependency"
    )
    is_fixed: bool = Field(False, description="Whether the vulnerability is fixed")
    fix_command: Optional[str] = Field(
        None, description="The command to fix the vulnerability"
    )
...
class TaskModel(BaseModel):
    ...
    dependencies: List[str] = Field(
        default_factory=list, description="The dependencies of the task"
    )
...
class ImplementationPlanModel(BaseModel):
    ...
    tasks: Dict[str, TaskModel] = Field(
        default_factory=dict, description="The tasks in the implementation plan"
    )
    start_time: Optional[str] = Field(
        None, description="The start time of the implementation plan"
    )
    end_time: Optional[str] = Field(
        None, description="The end time of the implementation plan"
    )
    current_phase: Optional[str] = Field(
        None, description="The current phase of the implementation plan"
    )
