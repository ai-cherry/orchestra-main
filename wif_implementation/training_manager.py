    ...
    def _conduct_training(self, plan: ImplementationPlan) -> bool:
        ...
        if self.dry_run:
            ...
            with open(records_path, "w") as f:
                ...
                f.write(
                    "- **Notes:** Session went well. Participants had questions about the security benefits of WIF.\n"
                )
    ...
    def _document_best_practices(self, plan: ImplementationPlan) -> bool:
        ...
        if self.dry_run:
            ...
            with open(checklist_path, "w") as f:
                ...
                f.write(
                    "Use this checklist to ensure you've properly implemented Workload Identity Federation.\n\n"
                )
                ...
                f.write(
                    "  - [ ] Service-specific APIs (e.g., Cloud Run, GKE, etc.)\n\n"
                )
