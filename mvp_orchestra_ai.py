...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("orchestra_ai_mvp.log")
    ]
)
...
async def main():
    ...
    chat_parser.add_argument("--mode", default="casual", choices=["casual", "analytical", "technical", "strategic", "creative"], help="Conversation mode")
