...
async def run_initialization() -> Dict[str, Any]:
    ...
    logger.info(f"System initialized with {state.get('resources_count', 0)} resources, "
...
async def main():
    ...
    if not any([args.init, args.discover, args.conflicts, args.config, 
                args.cleanup, args.integration, args.gcp, args.all]):
        args.init = True
