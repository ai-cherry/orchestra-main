...
def patch_module(use_recovery_mode=False):
    ...
    if "core.orchestrator.src.main" in sys.modules:
        ...
        try:
            ...
            print("Warning: core.orchestrator.src.main module not found. This is normal during container setup.")
    ...
    try:
        ...
        print("Note: Could not patch core.orchestrator.src.main directly. Environment variables still set.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Toggle between standard and recovery modes")
    parser.add_argument("--recovery", action="store_true", help="Use recovery mode (DISABLED - will always use standard mode)")
