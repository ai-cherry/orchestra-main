...
if __name__ == "__main__":
    ...
    async def main():
        ...
        parser.add_argument("--provider", choices=["firestore", "redis", "failover"], default="firestore",
        ...
        print(f"Running benchmark for {args.provider} with concurrency={args.concurrency}, operations={args.operations}...")
