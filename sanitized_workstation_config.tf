# Sanitized Terraform configuration for Cloud Workstations
...
variable "project_id" {
  ...
  type        = string
  default     = "YOUR_PROJECT_ID"  # Replace with your GCP project ID
}

variable "org_id" {
  description = "GCP organization ID"
  type        = string
  default     = "YOUR_ORGANIZATION_ID"  # Replace with your GCP organization ID
}
