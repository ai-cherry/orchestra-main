...
"""
    ...
    description="AI agent coordination and workflow management",
    version="1.0.0",
)
...
MODE_DEFINITIONS_PATH = os.getenv(
    ...
    "/home/paperspace/cherry_ai-main/config/mode_definitions.yaml",
)
AGENTS_CONFIG_PATH = os.getenv("AGENTS_CONFIG_PATH", "/home/paperspace/cherry_ai-main/config/agents.yaml")
...
async def startup_event():
    """Initialize conductor on startup"""
    logger.info("Starting conductor MCP Server...")

    # Start task worker
    asyncio.create_task(task_worker())

    logger.info("conductor MCP Server started successfully")
...
async def get_conductor_status(include_workflows: bool = True, include_tasks: bool = True) -> Dict[str, Any]:
