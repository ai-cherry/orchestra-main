...
class WorkflowExecutionResponse(BaseResponse):
    ...
    outputs: Optional[Dict[str, Any]] = Field(
        default=None, description="Workflow outputs"
    )
    task_results: Optional[Dict[str, Any]] = Field(
        default=None, description="Individual task results"
    )
...
class PersonaResponse(BaseResponse):
    ...
    persona_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Persona configuration"
    )
...
class DocumentAnalysisResponse(BaseResponse):
    ...
    keywords: Optional[List[str]] = Field(
        default=None, description="Generated keywords"
    )
    workflow_id: Optional[UUID] = Field(
        default=None, description="Analysis workflow ID"
    )
...
class ResearchResponse(BaseResponse):
    ...
    raw_findings: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="Raw research data"
    )
