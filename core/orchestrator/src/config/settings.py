...
class Settings(BaseSettings):
    ...
    DEFAULT_LLM_MODEL_FALLBACK_OPENAI: Optional[str] = (
        "gpt-4o"  # Fallback model for OpenAI
    )
    DEFAULT_LLM_MODEL_FALLBACK_ANTHROPIC: Optional[str] = (
    ...
    REDIS_AUTH_SECRET: Optional[str] = (
    ...
    OPENROUTER_FREE_FALLBACKS: Optional[str] = (
    ...
    MASTER_PORTKEY_ADMIN_KEY: Optional[str] = (
    ...
    PORTKEY_VIRTUAL_KEY_GOOGLE: Optional[str] = (
