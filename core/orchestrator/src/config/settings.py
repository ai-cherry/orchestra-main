...
class Settings(BaseSettings):
    ...
    def get_portkey_fallbacks(self) -> Optional[List[Dict[str, Any]]]:
        ...
        Returns:
            List of fallback configurations or None if not set
        """
    ...
    def get_openrouter_headers(self) -> Dict[str, str]:
        ...
        Returns:
            Dictionary of headers to include with OpenRouter requests
        """
        # Default headers
        headers = {
    ...
    def get_agent_model_map(self) -> Dict[str, str]:
        ...
        Returns:
            Dictionary mapping agent roles to specific models
        """
    ...
    def get_portkey_strategy_config(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with Portkey strategy configuration
        """
    ...
    def get_gcp_credentials_info(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with GCP credentials information
        """
        return {
