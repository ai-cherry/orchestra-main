...
try:
    ...
    class RedisCache:
        ...
        async def initialize(self) -> bool: return False
        async def close(self) -> None: pass
        async def get(self, key: str) -> Optional[Any]: return None
        async def set(self, key: str, value: Any, ttl: Optional[int] = None) -> bool: return False
        async def delete(self, key: str) -> bool: return False
        async def exists(self, key: str) -> bool: return False
        async def health_check(self) -> Dict[str, Any]: return {"status": "unavailable"}
