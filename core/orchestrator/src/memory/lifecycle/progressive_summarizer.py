...
class ProgressiveSummarizer:
    ...
    def __init__(self, config: Optional[ProgressiveSummarizerConfig] = None):
        ...
        logger.info(f"ProgressiveSummarizer initialized (Vertex AI: {self.config.use_vertex_ai})")
    ...
    async def summarize(
        ...
        if (level == SummaryLevel.CONDENSED and 
            content_length < self.config.min_length_for_condensed):
        ...
        if (level == SummaryLevel.KEY_POINTS and 
            content_length < self.config.min_length_for_key_points):
        ...
        if (level == SummaryLevel.HEADLINE and 
            content_length < self.config.min_length_for_headline):
    ...
    async def _extract_entities_and_keywords(
        ...
        stopwords = {"the", "and", "a", "an", "in", "on", "at", "to", "for", "with", 
