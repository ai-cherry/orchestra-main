...
class QueryClassifier:
    ...
    def __init__(
        ...
        self.factual_indicators = [
            ...
            "define", "explain", "list", "tell me about", "find",
            "show me", "give me", "name", "identify", "locate"
        ]
        
        self.conceptual_indicators = [
            "why", "how does", "what if", "compare", "contrast",
            "analyze", "evaluate", "similar to", "difference between",
            "relationship", "concept", "theory", "principle", "explain why",
            "reason for", "cause of", "effect of", "impact of", "significance of"
        ]
        
        self.conversational_indicators = [
            "can you", "could you", "would you", "i want", "i need",
            "help me", "please", "thanks", "thank you", "hi", "hello",
            "good morning", "good afternoon", "how are you", "nice to meet you"
        ]
    ...
    def _classify_with_rules(self, query: str) -> QueryClassificationResult:
        ...
        scores = {
            ...
            QueryType.CONVERSATIONAL.value: features.conversational_indicators * 0.2 + features.greeting_terms * 0.2 + (features.has_personal_pronouns * 0.1),
    ...
    def _extract_features(self, query: str) -> QueryFeatures:
        ...
        features = QueryFeatures(
            ...
            contains_question_mark="?" in query
        )
        ...
        features.conversational_indicators = sum(1 for indicator in self.conversational_indicators if indicator in query_lower)
        ...
        technical_indicators = ["algorithm", "system", "database", "function", "api", "interface", "protocol", "architecture"]
