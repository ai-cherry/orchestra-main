...
from core.orchestrator.src.agents.stateful_agent import StatefulAgent, ConversationalAgent
from core.orchestrator.src.agents.observable_agent import ObservableAgent, ResilientAgent
...
class ExampleToolUsingAgent(ToolUsingAgent, StatefulAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        ToolUsingAgent.__init__(self, tools=[
            CalculatorTool(),
            WeatherTool()
        ])
