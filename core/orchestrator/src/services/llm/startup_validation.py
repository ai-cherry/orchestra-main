...
def check_environment_variables(providers: Optional[List[str]] = None) -> Tuple[bool, Dict[str, List[str]]]:
    """
...
def check_optional_environment_variables(providers: Optional[List[str]] = None) -> Dict[str, List[str]]:
    """
...
def validate_poetry_install() -> bool:
    ...
    try:
        ...
        required_packages = [
            "litellm", "httpx", "pyjwt", "tenacity", 
            "prometheus-client", "google-cloud-secretmanager"
        ]
