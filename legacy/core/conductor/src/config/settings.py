...
"""
    """
    """
    APP_NAME: str = "AI coordination System"
    ...
    # Resource paths
    PERSONA_CONFIG_PATH: str = "core/conductor/src/config/personas"

    # Memory settings
    MEMORY_PROVIDER: str = "in_memory"  # For conductor's internal/simple memory needs
