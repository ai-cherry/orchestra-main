...
#!/usr/bin/env python3
"""
Lambda API Management Script for Orchestra-Main Project
Manages server infrastructure via Lambda API
"""
...
def main():
    # Initialize Lambda manager with API key
api_key = os.getenv('ORCHESTRA_INFRA_API_KEY')
    Lambda = LambdaManager(api_key)
    ...
    try:
        ...
        instance = lambda.find_instance_by_ip(target_ip)
        ...
        reboot_success = lambda.reboot_instance(instance_id)
        ...
        if reboot_success:
            ...
            for i in range(12):  # Wait up to 2 minutes
                ...
                time.sleep(10)
                updated_instance = lambda.get_instance(instance_id)["instance"]
