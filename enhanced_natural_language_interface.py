...
from enhanced_vector_memory_system import EnhancedVectorMemorySystem, ConversationContext, ContextualMemory
...
class ContextualResponseGenerator:
    ...
    async def _generate_with_model(self, prompt: str, model: str) -> str:
        ...
        try:
            response = self.portkey.chat.completions.create(
                model=model,
                messages=[
                    {"role": "system", "content": "You are an expert AI assistant with access to comprehensive business data."},
    ...
    async def _extract_response_metadata(
        ...
        action_indicators = [
            "should", "recommend", "suggest", "next step", "follow up", "schedule", "contact"
        ]
