  ...
  const conversations = [
    {
      ...
      lastMessage: "Thanks for the detailed outline. I'll start working on the draft."
    },
    {
      id: 'conv-002',
      ...
      lastMessage: "I've compiled all the research papers you requested. Would you like me to summarize the key findings?"
    },
    {
      id: 'conv-003',
      ...
      lastMessage: "Based on the data, I've identified three key trends that could help improve next quarter's performance."
    },
    {
      id: 'conv-004',
      ...
      lastMessage: "I've created the project timeline with all the milestones we discussed. I'll share it with the team."
    },
    {
      id: 'conv-005',
      ...
      lastMessage: "These are some great options! I'll present them to the marketing team tomorrow."
    },
    {
      id: 'conv-006',
      ...
      lastMessage: "Perfect! I can access my account now. Thank you for your help!"
    }
  ]
  
  // Filter conversations based on search query and date range
  const filteredConversations = conversations.filter(conversation => {
    const matchesSearch = conversation.agentName.toLowerCase().includes(searchQuery.toLowerCase()) || 
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">Conversation Explorer</h2>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  {filteredConversations.map((conversation) => (
                    <div
                      ...
                      className={`cursor-pointer rounded-md border p-4 transition-colors hover:bg-muted/50 ${
                        selectedConversation === conversation.id ? 'border-primary bg-muted/50' : ''
                      }`}
                    ...
                    >
                      ...
                      <div className="mt-1 text-sm text-muted-foreground">{conversation.summary}</div>
        ...
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              {conversationDetails ? `Conversation with ${conversationDetails.agentName}` : 'Select a conversation to view details'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {!conversationDetails ? (
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">{conversationDetails.agentName}</div>
                  </div>
                  <div>
                    <div className="text-sm font-medium">User ID</div>
                    <div className="text-sm text-muted-foreground">{conversationDetails.userId}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">{conversationDetails.duration}</div>
                  </div>
                  <div>
                    <div className="text-sm font-medium">Messages</div>
                    <div className="text-sm text-muted-foreground">{conversationDetails.messageCount}</div>
                  </div>
                </div>

                <div>
                  <div className="text-sm font-medium">Summary</div>
                  <div className="text-sm text-muted-foreground">{conversationDetails.summary}</div>
                </div>

                <div>
                  <div className="text-sm font-medium">Last Message</div>
                  <div className="text-sm text-muted-foreground">{conversationDetails.lastMessage}</div>
                </div>
