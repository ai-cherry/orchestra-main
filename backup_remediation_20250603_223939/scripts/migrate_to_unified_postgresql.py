...
class UnifiedPostgreSQLMigration:
    ...
    async def create_backup(self):
        ...
        tables_to_backup = [
            ("cherry_ai.sessions", "sessions.json"),
            ("cherry_ai.agents", "agents.json"),
            ("cherry_ai.workflows", "workflows.json"),
            ("cherry_ai.audit_logs", "audit_logs.json"),
        ]
    ...
    async def cleanup_deprecated_tables(self):
        """Remove deprecated tables and schemas."""
            "DROP TABLE IF EXISTS cherry_ai.sessions CASCADE",
            # Old cache tables
    ...
    async def validate_migration(self):
        """Validate the migration was successful."""
            ...
            ("cherry_ai.agents", "Agents table"),
            ("cherry_ai.workflows", "Workflows table"),
            ("cherry_ai.audit_logs", "Audit logs table"),
            ("cherry_ai.memory_snapshots", "Memory snapshots table"),
        ]
