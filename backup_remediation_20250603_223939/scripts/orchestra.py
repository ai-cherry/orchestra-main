#!/usr/bin/env python3
"""
    python scripts/cherry_ai.py query "your question"  # Query agents
    python scripts/cherry_ai.py health       # Run health checks
"""
    ...
    def cmd_start(self) -> int:
        ...
        status = self.get_service_status()
        if status["api_server"]:
            print("\n✅ Cherry AI started successfully!")
    ...
    def cmd_query(self, query: str) -> int:
        """Query the agents."""
            ...
            print("   Run: python scripts/cherry_ai.py start")
            return 1
        except Exception:
...
def main():
    """Main entry point."""
        description="Cherry AI Unified CLI",
