...
"""
    ...
    def _show_usage_examples(self) -> None:
        ...
        print(f"export RECRAFT_API_KEY= os.getenv('API_KEY')")
        print(f"export OPENAI_API_KEY= os.getenv('API_KEY')")
        print(f"export OPENROUTER_API_KEY= os.getenv('API_KEY')")
        print(f"export ANTHROPIC_API_KEY= os.getenv('API_KEY')")
        print(f"")
...
async def main():
    ...
    if not available_keys:
        ...
        print("  export RECRAFT_API_KEY= os.getenv('API_KEY')")
