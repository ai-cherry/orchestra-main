...
class SimplifiedGCPAuth:
    ...
    def get_credentials(self) -> Any:
        ...
        try:
            ...
            logger.info("Run 'gcloud auth application-default login' or provide a service account key")
            return None
        except Exception as e:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test", choices=["firestore", "storage", "secretmanager"], 
                        help="Test specific client initialization")
    
    args = parser.parse_args()
    
    # Create auth instance
    auth = SimplifiedGCPAuth(
        service_account_path=args.key,
